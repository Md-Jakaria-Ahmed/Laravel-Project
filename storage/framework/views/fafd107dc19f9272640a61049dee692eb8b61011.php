...
<head>
    ...
    <meta name="author" content="Jakaria Ahmed">
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('template/img/favc.png')); ?>">
...
<body id="page-top">
    ...
    <?php echo $__env->yieldContent('page_body'); ?>
...
<?php /**PATH C:\xampp\htdocs\Dashboard\resources\views/layout/primary.blade.php ENDPATH**/ ?>